...
public class memoryAddress(memoryStorageToUse : HashListTypes.MemoryStorage) {

    let memoryStorage : MemoryStorage = memoryStorageToUse;

    private type KeyInfo = HashListTypes.KeyInfo;
    var blobHashFunc = GlobalFunctions.blobHash;
    var nat32IdentityFunc = GlobalFunctions.nat32Identity;
    private type MemoryStorage = HashListTypes.MemoryStorage;
